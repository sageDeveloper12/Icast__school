...
const Primary = () => {
    ...
    const [imageUrl2, setImageUrl2] = useState(primarySchoolImage[1]);
    ...
    return (
            ...
            <div className="primary section">
                ...
                <div className="primary__container">
                    ...
                    <h3 className="link"><Link to="/">HOME</Link>/PRIMARY SCHOOL</h3>
                        ...
                        <div className="school__overview-container container">
                            <div className="left box">
                                <div className="image__container">
                                    ...
                                    <img src={imageUrl2} alt="" className="small__image" />
                                </div>
                            </div>
